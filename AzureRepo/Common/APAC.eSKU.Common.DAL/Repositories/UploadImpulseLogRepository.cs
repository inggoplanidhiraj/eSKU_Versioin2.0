...
{
    public class UploadImpulseLogRepository : Repository<UploadImpulseLog>, IUploadImpulseLogRepository

    {
        public UploadImpulseLogRepository(eSKUContext eSKUcontext) : base(eSKUcontext)
        {
        }
